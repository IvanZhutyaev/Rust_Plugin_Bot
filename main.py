        ...
        request_data = {
            ...
            "messages": [
                {"role": "system", "content": (
                    ...
                    "Не добавляй оговорки о том, что ты не разработчик, не повторяй описание пользователя, "
                    "Если возникает сомнение, просто генерируй рабочий код без объяснений про свою компетенцию."
                    "Не добавляй лишние пояснения, кроме комментариев в коде."
                )},
